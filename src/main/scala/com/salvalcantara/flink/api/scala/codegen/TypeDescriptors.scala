...
@Internal
trait TypeDescriptors[C <: Context] { this: MacroContextHolder[C] =>
  import c.universe._
  ...
  case class FactoryTypeDescriptor(id: Int, tpe: Type, baseType: Type, params: Seq[UDTDescriptor]) extends UDTDescriptor
...
//    }
  ...
  case class FieldDescriptor(name: String, getter: Symbol, setter: Symbol, tpe: Type, desc: UDTDescriptor)
  ...
  case class JavaTupleDescriptor(id: Int, tpe: Type, fields: Seq[UDTDescriptor]) extends UDTDescriptor {
