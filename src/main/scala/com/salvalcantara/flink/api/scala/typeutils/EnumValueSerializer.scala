...
object EnumValueSerializer {
  ...
  class ScalaEnumSerializerConfigSnapshot[E <: Enumeration] extends TypeSerializerConfigSnapshot[E#Value] {
    ...
    override def read(in: DataInputView): Unit = {
      ...
      try {
        if (getReadVersion == 1) {
          ...
          enumClass = Class.forName(in.readUTF(), true, getUserCodeClassLoader).asInstanceOf[Class[E]]
    ...
    override def equals(obj: scala.Any): Boolean = {
      ...
      enumConstants.equals(obj.asInstanceOf[ScalaEnumSerializerConfigSnapshot[E]].enumConstants)
    }
